...
export default function Page() {
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-16 space-y-14">
      <header className="space-y-3">
        <h1 className="text-3xl font-semibold">Sistema visual</h1>
        <p className="text-muted-foreground">
          Referencia del tema: colores, tipografía y componentes base. Cualquier
          pantalla nueva se arma con estas piezas, no con estilos propios.
        </p>
      </header>
